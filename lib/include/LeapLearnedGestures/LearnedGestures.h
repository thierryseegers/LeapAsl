...
public:
    ...
    Listener(Trainer const& trainer, int const types = LearnedGesture::TYPE_ALL, duration const& hold_time = std::chrono::milliseconds(1000), duration const& sample_rate = std::chrono::milliseconds(100))
    : hold_time(hold_time)
